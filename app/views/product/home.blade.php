			...
			<div class="row row--grid">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="./add-product" class="main__title-link">add item</a>
					</div>
				</div>
				<!-- end main title -->
					...
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								...
								<a class="dashbox__more" href="./product">View All</a>
							</div>
						</div>
				...
				<div class="col-12 col-xl-6">
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="#"><i class="icon ion-ios-refresh"></i></a>
								<a class="dashbox__more" href="./cart">View All</a>
							</div>
						</div>
				...
				<div class="col-12 col-xl-6">
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="#"><i class="icon ion-ios-refresh"></i></a>
								<a class="dashbox__more" href="./cate-product">View All</a>
							</div>
						</div>
