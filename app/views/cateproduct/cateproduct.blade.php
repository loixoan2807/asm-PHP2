                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-btns">
                                        ...
                                        <a href="./update-cate-product-{{$value['id']}}" class="main__table-btn main__table-btn--edit">
                                            <i class="icon ion-ios-create"></i>
                                        </a>
                                        <a href="./delete-cate-product-{{$value['id']}}" class="main__table-btn main__table-btn--delete ">
