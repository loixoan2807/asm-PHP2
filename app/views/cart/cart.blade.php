                    ...
                    <table class="main__table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text"><a href="#">{{$value["so_luong"]}}</a></div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="main__table-btns">
                                        ...
                                        <a href="./add-cart" class="main__table-btn main__table-btn--view">
                                            <i class="icon ion-ios-eye"></i>
                                        </a>
                                        <a href="./update-cart-{{$value['id']}}" class="main__table-btn main__table-btn--edit">
                                            <i class="icon ion-ios-create"></i>
                                        </a>
                                        <a href="./delete-cart-{{$value['id']}}" class="main__table-btn main__table-btn--delete">
